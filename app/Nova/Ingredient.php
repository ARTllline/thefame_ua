...
class Ingredient extends Resource
{
    ...
    {
        return __('Ингредиенты');
    }

    public static function singularLabel()
    {
        return __('Ингредиент');
    }
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make('Ссылка на каталог', function () {
                return '<a href="' . route('catalogue.resolve','ingredient/' . $this->slug) . '" target="_blank">' . route('catalogue.resolve', 'ingredient/'. $this->slug) . '</a>';
            })->asHtml(),
        ];
    }
}
